...
<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/assets/css/animate.css"/>
...
<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/assets/css/font.css"/>
<!--[if lt IE 9]>
